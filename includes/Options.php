	...
	public function render_settings_page() {
        ...
        <div class="wrap" style="margin:0">
            ...
            <div class="privacy-settings-body hide-if-no-js">
                <h2><?php esc_html_e( 'Report an Issue', 'hide-admin-notices' ); ?></h2>
                <p>
                    <strong><?php esc_html_e( "Use this form to report an issue with one of your installed plugins.", 'hide-admin-notices' ); ?></strong>
                </p>
                ...
                <form method="post" action="">
                    ...
                    <table class="form-table" role="presentation">
                        ...
                        <tr>
                            <th scope="row"><label
                                        for="hide-admin-notices-options[comments]"><?php esc_html_e( 'Can you describe the issue?', 'hide-admin-notices' ); ?></label>
                            </th>
                            <td>
